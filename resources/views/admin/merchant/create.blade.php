        ...
        <div class='col-lg-12'>
            <div class='card'>
                <div class='card-body'>
                    ...
                    <form action="{{ route('rabsana-psp.admin-api.v1.merchants.store') }}" method='POST'
                        ...
                        <div class='row p-2'>
                            ...
                            <div class='col-md-8 my-2'>
                                <div class='form-group mb-2'>
                                    <label for='user_id'>
                                        @lang('rabsana-psp::psp.user_selection')
                                    </label>
                                    <select class="form-control" id="user_id" name="user_id" required
                                            data-url="{{ route('rabsana-psp.admin-api.v1.get.users') }}">
                                    </select>
                                </div>
                            </div>
